...
public class Alumno {
	...
	public String calificacion(double nota) {
		...
		else if (nota == 10) return "Matr�cula";
	...
	public String cursoSegunEdad(int anyoNacimiento) {
		...
		if (anyoNacimiento == 2017) return "1� Educaci�n Infantil";
		else if (anyoNacimiento == 2016) return "2� Educaci�n Infantil";
		else if (anyoNacimiento == 2015) return "3� Educaci�n Infantil";
		else if (anyoNacimiento == 2014) return "1� Educaci�n Primaria";
		else if (anyoNacimiento == 2013) return "2� Educaci�n Primaria";
		else if (anyoNacimiento == 2012) return "3� Educaci�n Primaria";
		else if (anyoNacimiento == 2011) return "4� Educaci�n Primaria";
		else if (anyoNacimiento == 2010) return "5� Educaci�n Primaria";
		else if (anyoNacimiento == 2009) return "6� Educaci�n Primaria";
		else if (anyoNacimiento == 2008) return "1� Educaci�n Secundaria";
		else if (anyoNacimiento == 2007) return "2� Educaci�n Secundaria";
		else if (anyoNacimiento == 2006) return "3� Educaci�n Secundaria";
		else if (anyoNacimiento == 2005) return "4� Educaci�n Secundaria";
